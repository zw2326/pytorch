...
import dataclasses
from typing import Any, Generator, List, Optional, Tuple, Sequence
...
class ExportErrorLogParser:
    ...
    def parse_csv(self, output_filename: pathlib.Path) -> Generator[OnnxExportErrorRow, Any, Any]:
        try:
    ...
    def gen_summary_files(self):
        ...
        str_io.write(f"# Export Error Summary Dashboard ##\n")
        str_io.write("\n")
