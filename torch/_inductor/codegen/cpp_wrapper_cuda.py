...
from typing import Any, List, Optional, TYPE_CHECKING, Callable
...
class CppWrapperCuda(CppWrapperCpu):
    ...
    def generate_default_grid(self, name: str, grid: List[Any], cuda: bool = True, grid_callable: Optional[Callable] = None, **grid_extra_kwags):
        """
