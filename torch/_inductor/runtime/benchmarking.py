...
class Benchmarker:
    ...
    def benchmark_gpu(self, _callable: Callable[[], Any], estimation_iters: int = 5, memory_warmup_iters: int = 500, benchmark_iters: int = 100, max_benchmark_duration: int = 25) -> float:        
