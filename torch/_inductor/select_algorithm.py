...
class AlgorithmSelectorCache(PersistentCache):
    def __init__(self, *args, **kwargs):
        ...
        self.feedback_saver_fns: List[
            Callable[[Dict[int, float], str, List[Any], List[ChoiceCaller]], None]
        ] = []
    ...
    def add_feedback_saver(
        self, fn: Callable[[Dict[int, float], str, List[Any], List[ChoiceCaller]], None]
    ):
...
def _init_algorithm_selector_cache() -> None:
...
def autotune_select_algorithm(*args, **kwargs):
    _init_algorithm_selector_cache()
...
def add_feedback_saver(
    fn: Callable[[Dict[int, float], str, List[Any], List[ChoiceCaller]], None]
):
    _init_algorithm_selector_cache()
